...
public class Translate {
    ...
    public static void main(String[] args) throws Exception {
        String txt="Brosse à dents jetable adulte aléatoire chaude avec de la pâte pour le décapant enveloppé par hôtel H5D0 W5Q0";
        Translate g = Translate.getInstance();
        String newstr  = txt.toLowerCase();
        String translateText = g.translateText(newstr, "auto", "en");
        System.out.println("翻译1："+translateText);
        //System.out.println("翻译2："+ g.translateText(translateText,"auto","zh_cn"));
    }
