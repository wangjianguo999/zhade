...
/**
 * tab_recharge_jiangli_logEntity
 * @author 4
 * @version 2022-04-08
 */
@Table(name="tab_recharge_jiangli_log", alias="a", label="tab_recharge_jiangli_log信息", columns={
...
public class TabRechargeJiangliLog extends DataEntity<TabRechargeJiangliLog> {
	...
	public TabRechargeJiangliLog() {
		this(null);
	}

	public TabRechargeJiangliLog(String id){
		super(id);
	}
