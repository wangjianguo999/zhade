...
/**
 * tab_recharge_success_tongjiEntity
 * @author 1
 * @version 2022-04-04
 */
@Table(name="tab_recharge_success_tongji", alias="a", label="tab_recharge_success_tongji信息", columns={
...
public class TabRechargeSuccessTongji extends DataEntity<TabRechargeSuccessTongji> {
	...
	public TabRechargeSuccessTongji() {
		this(null);
	}

	public TabRechargeSuccessTongji(String id){
		super(id);
	}
