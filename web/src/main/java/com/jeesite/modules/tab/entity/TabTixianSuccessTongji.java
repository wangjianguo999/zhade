...
/**
 * tab_tixian_success_tongjiEntity
 * @author 32
 * @version 2022-04-04
 */
@Table(name="tab_tixian_success_tongji", alias="a", label="tab_tixian_success_tongji信息", columns={
...
public class TabTixianSuccessTongji extends DataEntity<TabTixianSuccessTongji> {
	...
	public TabTixianSuccessTongji() {
		this(null);
	}

	public TabTixianSuccessTongji(String id){
		super(id);
	}
